...
export function NewAssignmentForm({ classId }: { classId: string }) {
  ...
  return (
    <form action={formAction} className="flex flex-col gap-3">
      ...
      <label htmlFor="requiresAudio" className="flex items-center gap-2 text-sm">
        <input id="requiresAudio" name="requiresAudio" type="checkbox" className="accent-primary" />
        Requires a spoken (audio) response
      </label>
